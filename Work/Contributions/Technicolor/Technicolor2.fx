...
float4 bluegreenfilter : COLOR  = {0.0, 1.0, 1.0, 1.0};
float4 cyanfilter : COLOR  = {0.0, 1.0, 0.5, 1.0};
float4 magentafilter : COLOR  = {1.0, 0.0, 0.25, 1.0};
...
float4 PS_Technicolor2(vs2ps In): COLOR
...
technique Technicolor2
{
    pass p0
    {
        ...
        PixelShader = compile ps_2_0 PS_Technicolor2();
    }
